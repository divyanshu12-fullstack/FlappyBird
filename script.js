...
const collisionSound = new Audio("./sounds/die-101soundboards.mp3");
const passSound = new Audio("./sounds/point-101soundboards.mp3");
const resetSound = new Audio("./sounds/swoosh-101soundboards.mp3");
